...
function EventCard({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-3xl flex flex-col md:flex-row justify-between items-stretch gap-4 m-4",
    ...
    >
      ...
      <div className={!isBanner && imageUrl ? "md:w-1/4 flex-shrink-0 relative h-40 md:h-auto" : "flex-1"}>
        {!isBanner && imageUrl && (
          <Image
            src={imageUrl}
